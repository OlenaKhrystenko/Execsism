public class RemoteControlCar
{
    ...
    public TelemetryComponent Telemetry => new TelemetryComponent(this);
/*
    public RemoteControlCar()
    {
        Telemetry = new TelemetryComponent(this);
    }
  */  
    public class TelemetryComponent
    {
        ...
        public TelemetryComponent(RemoteControlCar remoteControlCar)
        {
